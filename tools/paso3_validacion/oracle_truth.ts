...
export const ORACLE: Record<string, OracleCase> = {
  ...
  miguel_lugo: {
    ...
    productos: [
      ...
      { institucion: 'Banco de Chile', monto: 45_798, seccion: 261, operacion: '97000', doc: 'ESTADO DE DEUDA - Banco de Chile.pdf', cmf: false, moneda: 'CLP', leido: true, nota: 'VARIOS DEUDORES, NO-CMF — la abogada lo declaró en 261 (screenshot)' },

/**
 * Encola el job E2E de Miguel Lugo: step 0 (Pasos 1→4), DRY_RUN=false (borrador vivo).
 * Limpia jobs activos previos del cliente para evitar choque con el índice único.
 *
 * Uso: npx ts-node -r dotenv/config casos/miguel_lugo/enqueue.ts
 */
import { createClient } from '@supabase/supabase-js';
import * as dotenv from 'dotenv';
dotenv.config();

const RUT = '26.625.555-1';

...
const DOCS_TO_UPLOAD = [
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Banco de Chile', 'informeCredito.pdf'),
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Ripley', 'RIPLEY AGOSTO.pdf'),
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Ripley', 'RIPLEY SEPTIEMBRE.pdf'),
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Ripley', 'RIPLEY OCTUBRE.pdf'),
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Ripley', 'RIPLEY NOVIEMBRE.pdf'),
  ...
  {
    local: path.join(CLAUDIA_DIR, 'Acreedores ', 'Banco de Chile', 'ACFrOgCRplTbZILphaIXMl-X0Ua2g0wtJDuD7QjK9DoxTPMp2OW7aJuVxMK-HlDrRt286GqBAtSc83TWjyopoVfJAxfrfAzoMSNT4zHLyHbxq6vn2nMCBhvBDz_9BdnaVS6WznsLf6Tgj1pc-WgvfzmmgbT-9bp_yvfMhuTlsw==.pdf'),

...
- **Boletas de honorarios (NO bloquean):** la carpeta SII muestra **5 boletas de honorarios emitidas en 2025** (enero, abril, septiembre, octubre y noviembre). Estas **no bloquean** la renegociación — se declaran en el Paso 5 (promedio últimos 6 meses ÷ 6). No tiene F29 con actividad. El impedimento real es **documental**: falta cert de saldo La Araucana + cert de deuda vigente Forum.
